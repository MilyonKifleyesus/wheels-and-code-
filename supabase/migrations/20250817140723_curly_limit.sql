/*
  ...
  2. Create content_sections table
...
-- First, fix the profiles table policies to eliminate infinite recursion
...
-- Create simple policies for bookings without complex joins
...
-- Now create the content_sections table
...
('new-arrivals', 'New Arrivals', true, 3, '{
  ...
  "description": "Discover our newest collection of quality pre-owned vehicles",
...
('contact', 'Contact Section', true, 7, '{
  ...
  "description": "Contact us for more information about our vehicles and services",
